...
#PBS -m ae
#PBS -o /scratch/es47540/rawdata/aneuploidy/peter/output
#PBS -e /scratch/es47540/rawdata/aneuploidy/peter/error


cd /scratch/es47540/rawdata/aneuploidy/peter/fastq
...
do
        ...
        echo "#PBS -q bensasson_q" >> scripts/${strain}_map.sh
        echo "#PBS -l walltime=24:00:00,mem=32gb,nodes=1:ppn=1" >> scripts/${strain}_map.sh
        echo "#PBS -M eduardoscopel@uga.edu" >> scripts/${strain}_map.sh
        echo "#PBS -m ae" >> scripts/${strain}_map.sh
        echo "#PBS -e /scratch/es47540/rawdata/aneuploidy/peter/fastq/error" >> scripts/${strain}_map.sh
        echo "#PBS -o /scratch/es47540/rawdata/aneuploidy/peter/fastq/output" >> scripts/${strain}_map.sh
        echo " " >> scripts/${strain}_map.sh
        echo "cd /scratch/es47540/rawdata/aneuploidy/peter/fastq" >> scripts/${strain}_map.sh
        ...
        echo "module load BCFtools/1.6-foss-2016b" >> scripts/${strain}_map.sh
        echo " " >> scripts/${strain}_map.sh
        ...
        echo "samtools mpileup -I -d 100000 -uf /scratch/es47540/rawdata/sacCer3/sacCer3.mfa ../bam/${strain}.sorted.bam | bcftools call -c > ../vcf/${strain}.vcf" >> scripts/${strain}_map.sh
        echo "module load R/3.5.0-foss-2018a-X11-20180131-GACRC" >> scripts/${strain}_map.sh
        echo "cd /scratch/es47540/rawdata/aneuploidy/peter/vcf" >> scripts/${strain}_map.sh
        echo "vcf2allelePlot.pl -w 100000 -D -m -i ${strain}.vcf  -o ${strain}" >> scripts/${strain}_map.sh
        echo " " >> scripts/${strain}_map.sh
