...
do
        ...
        echo "cd /scratch/es47540/rawdata/ploidy_review/Scer/ControlFreec/output/s.control/" >> ${strain}_RunCF.sh
        ...
        echo " " >> ${strain}_RunCF.sh
        echo "/scratch/es47540/apps/ControlFreec/FREEC-11.4/src/freec -config /scratch/es47540/rawdata/ploidy_review/Scer/ControlFreec/config_files/${strain}.txt" >> ${strain}_RunCF.sh
